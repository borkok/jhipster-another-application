...
import io.github.jhipster.application.JhipsterAnotherApplicationApp;
 ...
 */
@SpringBootTest(classes = JhipsterAnotherApplicationApp.class)
public class HowOftenResourceIT {
    ...
    public void createHowOften() throws Exception {
        ...
        assertThat(testHowOften.getNumber()).isEqualTo(DEFAULT_NUMBER);
    ...
    public void updateHowOften() throws Exception {
        ...
        HowOften testHowOften = howOftenList.get(howOftenList.size() - 1);
        assertThat(testHowOften.getNumber()).isEqualTo(UPDATED_NUMBER);
